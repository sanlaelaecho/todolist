...
//no const or save because we just need to run it
require('./config/database')
//const path = require('path')  no longer needed if app.get path.join is moved to app
// running this will connect our database to MERN app
// path scope in app only in app so need to call here in server as well
const app = require('./app-server')

const PORT = process.env.PORT || 8000

/*needs to be last thing and by putting here confirms last thing
/* needs to rewrite every time?
app.get('*', (req, res) => {
